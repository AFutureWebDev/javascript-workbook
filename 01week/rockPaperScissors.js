...
function rockPaperScissors(hand1, hand2) {
  // input changed to lowercase and trim whitespace
...
if (typeof describe === 'function') {
  ...
  describe('#rockPaperScissors()', () => {
    ...
    it('should detect a valid entry - rock, paper, scissors', () => {
      assert.equal(rockPaperScissors('unicorn', 'flowers'), "This is an invalid entry");
    });
  })
} else {
